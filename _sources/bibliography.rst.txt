...
layer, which directly captures high-order many-body information, was built in :cite:t:`allen2025optimal`.
...
in :cite:t:`matin2025teacher` and :cite:t:`matin2025ensemble`. In :cite:t:`zhang2024including`,
a physics-informed constraint for atomization of molecules was introduced to improve the
performance of models far from equilibrium. A potential for Uranium Nitride was
investigated in :cite:t:`alzate2024machine`.
...
equilibrated charges, was employed, using a shadow dynamics technique to avoid
