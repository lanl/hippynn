...
class PaddingIndexer(AtomIndexer, AutoNoKw, ExpandParents, MultiNode):
    ...
    """
    _output_names =  "indexed_features", "real_atoms",\
                     "inv_real_atoms", "mol_index",\
                     "atom_index","n_molecules","n_atoms_max"
...
def acquire_encoding_padding(search_nodes, species_set, purpose=None):
    ...
    try:
        ...
        if species_set is None:
            raise ValueError("Building encode and padder requires a species_set, but a species set is not specified,"
