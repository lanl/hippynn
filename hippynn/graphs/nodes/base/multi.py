...
class MultiNode(Node): #Multinode
    ...
    def __init__(self,name,parents,module='auto',*args,db_name=None,**kwargs):
        ...
        self.children = tuple(
                             ...
                             for i,(cn,cidx) in
                             enumerate(zip(self._output_names, self._output_index_states))
                             )
    ...
    def __init_subclass__(cls,**kwargs):
        ...
        if cls._output_index_states is not NotImplemented:
            if len(cls._output_index_states) != len(cls._output_names):
                ...
                "Lengths of _child_index_states {} doesn't match lengths of ouput_names {}"\
                    .format(cls._output_index_states, cls._output_names))
        ...
        if cls._input_names is not NotImplemented:
            try:
                ...
                raise ValueError("Multi-node output names {} conflict with input names {}"\
                                 .format(cls._output_names,cls._input_names)) from ae
