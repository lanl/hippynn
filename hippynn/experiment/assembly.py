...
from hippynn.graphs.nodes.base import InputNode, LossInputNode, LossPredNode, LossTrueNode, _BaseNode
...
def determine_out_in_targ(*nodes_required_for_loss: _BaseNode):
    """
