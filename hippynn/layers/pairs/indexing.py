...
class ExternalNeighbors(_PairIndexer):
    ...
    def forward(self, coordinates, real_atoms, shifts, cell, pair_first, pair_second):
        atom_coordinates = coordinates.squeeze(0)[real_atoms]
        paircoord = atom_coordinates[pair_second] - atom_coordinates[pair_first] + shifts.to(cell.dtype) @ cell.squeeze(0)
