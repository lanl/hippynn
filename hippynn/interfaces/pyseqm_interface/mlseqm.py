...
class MLSEQM(torch.nn.Module):
    def __init__(self,seqm_parameters):
        ...
        self.p = torch.nn.Parameter(
                params(method=self.method, elements=self.elements,root_dir=self.filedir,
                parameters=self.learned), requires_grad=True)
        #
        self.const = Constants()
    ...
    def save(self, fdir="./MLSEQM/"):
        ...
        p1 = params(method=self.method, elements=self.elements,root_dir=self.filedir,
...
class MLSEQM_Node(AutoKw, MultiNode):
    ...
    _output_names = "mol_energy", "Etot_m_Eiso", "orbital_energies", \
                    ...
                    "electric_energy", "nuclear_energy", "isolated_atom_energy", \
                    "orbital_charges", "notconverged", "atomic_charge"
