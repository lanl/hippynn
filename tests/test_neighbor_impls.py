...
from hippynn.graphs.nodes.pairs import PeriodicPairIndexer, PeriodicPairIndexerMemory, SparsePairIndexer, NumpyDynamicPairs, KDTreePairs, KDTreePairsMemory
...
@pytest.mark.parametrize("pairfinder_cls",
