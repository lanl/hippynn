...
md1 = Molecular_Dynamics_Langevin(
    seqm_parameters,
    timestep=dt,
    damp=100.0,
    Temp=300.0,
...
coordinates, velocities, acceleration = md0.run(
    const, N, coordinates, velocities, species, learned_parameters=leared_par_generator
)
coordinates, velocities, acceleration = md1.run(
    const, N, coordinates, velocities, species, learned_parameters=leared_par_generator
)
coordinates, velocities, acceleration, P, Pt = md2.run(
    const, N, coordinates, velocities, species, learned_parameters=leared_par_generator
)
