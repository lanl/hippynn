...
dataset_path = os.path.join(os.path.dirname(__file__), "../../../data/files")
...
#"""
learned = ['U_ss', 'U_pp', 'zeta_s', 'zeta_p','beta_s', 'beta_p',
...
with hippynn.tools.log_terminal("training_log_tag_%d.txt" % TAG,'wt'):# and torch.autograd.set_detect_anomaly(True):
    ...
    molecule_energy = henergy.electric_energy + henergy1.mol_energy
    ...
    plot_maker = plotting.PlotMaker(
        ...
        #                             saved="HierPlot.pdf"),
        plot_every=5,   # How often to make plots -- here, epoch 0, 10, 20...
    )
...
# ----------------- #
    ...
    callbacks = [update_scf_eps(seqm_module, 0.5), 
