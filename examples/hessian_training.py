...
# Active directory
active_directory = "hessian_training_run"
...
# === HVP Vector Node ===
# HVPVector = physics.HVPVectorNode("hvp_vector", (positions,), vector_type="onehot")
...
losses = {
    ...
    "H-RMSE": WeightedMSELoss(hessian.hessian.pred, hessian.hessian.true, hessian.hessian_mask.pred) ** (1 / 2)
}

losses["LossTotal"] = losses["E-RMSE"] + force_coefficient * losses["F-RMSE"]# + hessian_coefficient * losses["H-RMSE"]
...
# === Assemble Graph ===
graph = GraphModule((species, positions), [energy, force, hessian.hessian])
...
database = PyAniFileDB(
    file="../../datasets/RTP_processed/gau-files-12k.h5", # Change this to your h5 file dataset location
